...
const InProgressView: React.FC<InProgressProps> = ({ 
  // source
 }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>{t("in_progress.title")}</Text>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  animation: {
    ...
    // marginRight,
    // alignSelf: "center",
    width: "100%", // You may keep maxWidth if you want it to be responsive
    height: "100%", // Adjust this to the actual height of the visible animation
  ...
  text: {
    ...
    position: "absolute",
    // bottom: HEIGHT - 700, // Adjust this value to position the text correctly
  },
});
